...
url(https://image.tmdb.org/t/p/w1280/${randomMovie?.backdrop_path})`,
      ...
      >
        <div className="flex justify-between items-center sm:mx-20 pt-6 mx-4">
          <div className="flex">
            <Link to="/">
          ...
          <form onSubmit={searchMovie}>
            <div className="relative mx-4">
              <input
                ...
                className="bg-black/20 sm:w-[25rem] md:w-[28rem] text-white rounded border p-4"
              />
              <button type="submit">
                <Icon
                  className="absolute inset-0 top-4 sm:left-[265px] text-white md:left-[295px] left-[150px]"
                  path={mdiMagnify}
                  size={1}
                />
              </button>
          ...
          <div className="flex text-white">
            <div className="md:mt-2">
              <p className="text-3xl hidden md:contents font-bold">Sign in</p>
            </div>
            ...
            <div className="random-movie-info">
              ...
              <div className="my-8 flex justify-between w-[160px]">
                <div className="flex mr-10 text-xl">
                  ...
                  <span className="pl-6">{randomMovie.vote_average}</span>
                </div>
      ...
      <main className="sm:mx-20 mx-4">
        <div className="flex justify-between my-14">
          <p className="font-bold sm:text-3xl text-[20px]">Featured Movie</p>
          <p
          ...
          <div className="font-bodyFont grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            {movies.slice(0, displayedMovies).map((movieReq) => (
              <Card
                ...
                vote_average={movieReq.vote_average.toString()} 
