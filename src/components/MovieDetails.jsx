                                ...
                                <>
                                        <div className="font-bodyFont">
                                                ...
                                                >
                                                        <Headroom className="bg-black/50">
                                                                <Link to="/" className="flex justify-center py-3" >
                                                                        ...
                                                                        <span className="pt-3 pl-3 text-white font-bold text-2xl">MovieBox</span>
                                                                </Link>
                                                        </Headroom>
                                                ...
                                                <div className="flex sm:mx-10 mx-4 pt-6 font-bold">
                                                        ...
                                                        <p data-testid="movie-title" className="text-red-700 pr-4 text-[14px]">{movieDetails.title}</p>
                                                        <p>•</p>
                                                        <span data-testid="movie-release-date" className="pl-4 text-[14px]">
                                                                Release Date (UTC): {movieDetails.release_date}
                                                        </span>
                                                </div>
                                                <p data-testid="movie-runtime" className="py-6 sm:mx-10 mx-4 font-bold text-[14px]">
                                                        Runtime:
